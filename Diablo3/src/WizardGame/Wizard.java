...
public class Wizard extends JFrame {
    ...
    WEnemyAttacks e = new WEnemyAttacks();
    int diabloStarted = 0;
    int frozen = 0;
    int e2Frozen = 0;
    int frozen12 = 0;
    ...
    ImageIcon originalIcon = new ImageIcon("WizardDown.png");
    ImageIcon demonUp = new ImageIcon("WizardUp.png");
    ImageIcon demonLeft = new ImageIcon("WizardLeft.png");
    ImageIcon demonRight = new ImageIcon("WizardRight.png");
    ImageIcon demonDead = new ImageIcon("WizardDead.png");
    ...
    ImageIcon fistOfThunderU = new ImageIcon("ThunderUnselected.png");
    ImageIcon fistOfThunderS = new ImageIcon("ThunderSelected.png");
    ImageIcon blastU = new ImageIcon("FreezeUnselected.png");
    ImageIcon blastS = new ImageIcon("FreezeSelected.png");
    ImageIcon monkSuperS = new ImageIcon("AbsorbSelected.png");
    ImageIcon monkSuperU = new ImageIcon("AbsorbUnselected.png");
    ImageIcon bloodForManaU = new ImageIcon("TimeFreezeUnselected.png");
    ImageIcon bloodForManaS = new ImageIcon("TimeFreezeSelected.png");
    ...
    ImageIcon Miss = new ImageIcon("FireBombFrozen.png");
    ImageIcon spikes = new ImageIcon("Enemy2Frozen.png");
    ...
    public Wizard() throws IOException {
        this.Enemy12 = new Wizard.Enemy12();
        this.Enemy22 = new Wizard.Enemy22();
        addKeyListener(new Wizard.AL());
        ...
        Enemy = new Wizard.Enemy();
        Enemy2 = new Wizard.Enemy2();
        this.DiabloThread = new Wizard.DiabloThread();
        Enemy.start();
        Enemy2.start();
       // DiabloThread.start();
        //DiabloThread = null;
    ...
    public class AL extends KeyAdapter { //method to store pressed key
        ...
        public void keyPressed(KeyEvent e) { // stores pressed button
            ...
            if (keyCode == KeyEvent.VK_D) {
                ...
                if (selected == 2) {
                    freeze = 1 + (int) (Math.random() * ((1 - 1) + 1));
                    if (mana < 19) {
                    ...
                    if (enemy1 == 1 && enemy2 == 1){
                        pauseEnemy(1);
                        pauseEnemy(2);
                    }else if (enemy1 == 1 && enemy2 == 2){
                        pauseEnemy(1);
                        pauseEnemy(22);
                    }else if (enemy1 == 2 && enemy2 == 1){
                        pauseEnemy(12);
                        pauseEnemy(2);
                    }
                    else if (enemy1 == 2 && enemy2 == 2){
                        pauseEnemy(12);
                        pauseEnemy(22);
                    }else if (enemy1 == 1 && Enemy22 == null){
                        pauseEnemy(1);
                    }else if (enemy1 == 2 && Enemy22 == null){
                        pauseEnemy(12);
                    }else if (enemy2 == 1 && Enemy12 == null){
                        pauseEnemy(2);
                    }else if (enemy2 == 2 && Enemy12 == null){
                        pauseEnemy (22);
                    }
    ...
    public class Enemy12 extends Thread {
...
public class Enemy22 extends Thread {
    ...
    public class DiabloThread extends Thread {
        ...
        public void run() {
//DiabloThread != null && Enemy == null && Enemy2 == null && Enemy12 == null && Enemy22 == null 
            while (diabloYN == 4) {
    ...
    public void pauseEnemy(int enemy) {
        if (enemy == 1) {
            Enemy = null;
            e11Paused = 1;
        }
    ...
    public void paint(Graphics g) {
        ...
        if (selected == 1){
            ...
            g.drawImage(bFMU, (fotS.getWidth(this) * 3) + hBarFull.getWidth(this) + 5, 780, this );
        }else if (selected == 2){
            ...
            g.drawImage (bU , fotS.getWidth(this) + hBarFull.getWidth(this) + 5, 780, this);
            g.drawImage(msU, (fotS.getWidth(this) * 2) + hBarFull.getWidth(this) + 5, 780, this );
            g.drawImage(bFMS, (fotS.getWidth(this) * 3) + hBarFull.getWidth(this) + 5, 780, this );
        }
            ...
            if (enemyHealth > 0) {
                if (enemy1 == 1) {
                    if (frozen == 0) {
                        ...
                        g.drawImage(miss, enemyX, enemyY, this);
                    }
                    ...
                    if (frozen12 == 0) {
                        ...
                        g.drawImage(SpikeTrap, enemyX, enemyY, this);
                    }
                }
            } else {
                ////enemiesLeft -= 1;
            ...
            if (enemy2Health > 0) {
                if (enemy2 == 1) {
                    if (e2Frozen == 0){
                        ...
                        g.drawImage(miss, enemy2X, enemy2Y, this);
                    }
                } else if (enemy2 == 2) {
                    if (frozen22 == 0){
                        if (e2Dir.equals("l")) {
                        ...
                        g.drawImage(SpikeTrap, enemy2X, enemy2Y, this);
                    }
